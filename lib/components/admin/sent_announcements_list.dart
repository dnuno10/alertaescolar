    ...
    final announcements = [
      {
        ...
        'content': 'Se les convoca a la reunión programada para el próximo viernes...',
      ...
      },
      {
        ...
        'content': 'Debido a actividades especiales, el horario de mañana será modificado...',
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    l10n.totalAnnouncementsSent ?? '${announcements.length} comunicados enviados',
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            l10n.createFirstAnnouncement ?? 'Cree su primer comunicado usando la pestaña anterior',
            style: AppTheme.getCaption(screenSize).copyWith(
              color: AppTheme.getTextSecondaryColor(context),
            ),
