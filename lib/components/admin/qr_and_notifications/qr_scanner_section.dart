...
class _QRScannerSectionState extends State<QRScannerSection>
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SolidButton(
            backgroundColor:
                _isScanning ? AppTheme.errorColor : AppTheme.accentBlue,
            onPressed: _toggleScanning,
            label: _isScanning
                ? l10n.stopScanning ?? 'Detener escaneo'
                : l10n.scanQR,
            icon: _isScanning
                ? Icons.stop_rounded
                : Icons.qr_code_scanner_rounded,
                        ...
                        border: Border.all(
                          color: _isScanning
                              ? AppTheme.accentBlue.withOpacity(
                                  0.5 + _scanningAnimation.value * 0.5)
  ...
  void _simulateScan() {
    ...
    setState(() {
      _lastScannedStudent =
          students[DateTime.now().millisecond % students.length];
